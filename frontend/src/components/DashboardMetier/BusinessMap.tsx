...
interface BusinessMapProps {
  ...
  emptyMessage?: string;
  selectedPanelOffsetClassName?: string;
}
...
export function BusinessMap({
  ...
  selectedPanelOffsetClassName = "top-[84px] right-4",
}: BusinessMapProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!isHomeMode && selected && popupProperties && (
          <Popup
      ...
      {isHomeMode && selected && popupProperties ? (
        <div className={`absolute ${selectedPanelOffsetClassName} right-4 z-20 max-w-[calc(100%-1.5rem)]`}>
          <BusinessPopup properties={popupProperties} variant="compact" onClose={() => setSelected(null)} />
        </div>
      ) : null}
