# Mini-lot — qualite.mesure_qualite_riviere

## Contexte

- table cible : `qualite.mesure_qualite_riviere`
- table(s) source(s) : `raw_mesures_qualite_rivieres`
- run_id source : `f0f2a858-1c90-4b15-a6af-cc172bece071`

## Metriques

- volume actuel table cible : `60097`
- volume candidat dans `qa_dry_run.e0_mesures_preparees` : `60074`
- volume en quarantaine `E0` a exclure : `11`
- volume source métier distinct détecté : `60074`
- volume déjà présent selon clé métier : `60118`
- volume potentiellement insérable : `0`
- doublons métier actuels dans la cible : `22`
- doublons métier dans la source préparée : `22`
- lignes avec `geo_ref` null dans la source préparée métier : `60074`
