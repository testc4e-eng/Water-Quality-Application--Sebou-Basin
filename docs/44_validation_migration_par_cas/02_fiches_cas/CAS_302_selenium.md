...
## Problème
Le paramètre `Sélénium` présente des valeurs interprétables avec règle explicite de parsing, mais cette règle doit être validée avant migration.
...
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_302_selenium.sql`
