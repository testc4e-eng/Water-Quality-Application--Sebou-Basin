...
## Problème
Le paramètre `TAC/TACs_°F` est rattaché à `TAC`, mais l'unité source n'est pas suffisamment stabilisée pour migrer sans validation humaine.
...
- flags : `UNIT_MISSING`
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_132_tac_tacs_f.sql`
