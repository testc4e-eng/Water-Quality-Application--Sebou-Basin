...
## Problème
Le paramètre `Carbone_org` est rattaché à `MO`, mais l'unité source n'est pas suffisamment stabilisée pour migrer sans validation humaine.
...
- flags : `UNIT_MISSING`
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_198_carbone_org.sql`
