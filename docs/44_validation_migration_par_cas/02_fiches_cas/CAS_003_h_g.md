...
## Problème
Le paramètre `H_G` reste ambigu vis-à-vis du standard métier proposé `HG / Hg` ; aucune décision implicite n'est autorisée.
...
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_003_h_g.sql`
