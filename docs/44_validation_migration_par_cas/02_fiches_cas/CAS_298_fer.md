...
## Problème
Le paramètre `Fer` présente des valeurs interprétables avec règle explicite de parsing, mais cette règle doit être validée avant migration.
...
- flags : `DECIMAL_COMMA`
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_298_fer.sql`
