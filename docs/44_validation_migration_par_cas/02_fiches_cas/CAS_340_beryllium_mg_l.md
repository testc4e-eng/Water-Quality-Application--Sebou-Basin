# CAS-340 Beryllium(mg/l)

## Identification
- parametre_observe : `Beryllium(mg/l)`
- nom_standard : `Be`
...
## Problème
Le rattachement de `Beryllium(mg/l)` vers `Be` existe, mais il reste des préconditions documentaires avant migration contrôlée.
...
- flags : `VALID`
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_340_beryllium_mg_l.sql`
