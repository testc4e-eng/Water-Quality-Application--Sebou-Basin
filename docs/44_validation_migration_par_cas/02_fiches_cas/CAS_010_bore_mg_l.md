...
## Problème
Le paramètre `Bore(mg/l)` n'est pas couvert par le mapping métier actuel et doit être arbitré avant toute migration.
...
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_010_bore_mg_l.sql`
