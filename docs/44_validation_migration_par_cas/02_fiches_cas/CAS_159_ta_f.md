...
## Problème
Le paramètre `TA_°F` est rattaché à `TA`, mais l'unité source n'est pas suffisamment stabilisée pour migrer sans validation humaine.
...
- flags : `UNIT_MISSING`
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_159_ta_f.sql`
