...
## Problème
Le paramètre `pH au laboratoire` contient des valeurs non numériques ou non interprétables qui bloquent une migration directe.
...
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_121_ph_au_laboratoire.sql`
