...
## Problème
Le paramètre `Fe` est déjà rattaché au standard métier `Fe`, mais la décision de migration reste à tracer cas par cas avant tout chargement.
...
- flags : `VALID`
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_376_fe.sql`
