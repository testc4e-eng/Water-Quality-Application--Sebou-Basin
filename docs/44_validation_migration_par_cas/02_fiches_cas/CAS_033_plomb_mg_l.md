...
## Problème
Le paramètre `Plomb(mg/l)` montre des valeurs hors plage attendue ou suffisamment suspectes pour imposer une quarantaine avant migration.
...
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_033_plomb_mg_l.sql`
