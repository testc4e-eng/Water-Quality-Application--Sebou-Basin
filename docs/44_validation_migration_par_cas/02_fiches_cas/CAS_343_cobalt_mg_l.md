...
## Problème
Le rattachement de `Cobalt(mg/l))` vers `Co` existe, mais il reste des préconditions documentaires avant migration contrôlée.
...
- flags : `VALID`
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_343_cobalt_mg_l.sql`
