...
## Problème
Le paramètre `NO3-_Réduction Cd` présente des valeurs interprétables avec règle explicite de parsing, mais cette règle doit être validée avant migration.
...
- flags : `DECIMAL_COMMA`
- SQL proposé (non exécuté) : `06_sql_en_attente/CAS_306_no3_reduction_cd.sql`
