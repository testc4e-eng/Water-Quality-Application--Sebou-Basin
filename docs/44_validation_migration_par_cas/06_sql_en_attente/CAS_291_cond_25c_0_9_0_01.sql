...
-- Cas : VALUE_PARSING / Cond 25°C *0,9*0,01
...
SELECT val_qual FROM public.idp_2024_mesures_qualite_marche_cadre WHERE parametre_qualite = 'Cond 25°C *0,9*0,01' AND val_qual::text ~ '[<>,]';
