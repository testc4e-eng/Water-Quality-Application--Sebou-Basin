> Version bureautique préparée pour export Word/PDF.
> 
> Consignes d'usage :
> - conserver les marqueurs \\newpage lors de la conversion ;
> - appliquer les styles Word sur les niveaux #, ## et ### ;
> - générer ensuite le sommaire automatique, la liste des tableaux et la pagination finale.
