...
- `docs/12_plan_execution_par_lots.md` a une taxonomie de statuts exploitable par humains et agents.
- `docs/25_annexes_blocages_et_incoherences.md` quantifie fortement les anomalies, notamment `ALIAS_UNMAPPED`, `NULL_VALUE`, `FORMAT_ERROR`, `NEGATIVE_VALUE`, `NON_NUMERIC`.
