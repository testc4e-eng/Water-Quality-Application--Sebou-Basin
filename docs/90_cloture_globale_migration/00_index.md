...
La migration historique de `abh_sebou_ismail` vers `abh_sad` est cloturee sans bloquant technique actif.
...
| `06_backlog_technique.md` | backlog technique non bloquant |
...
| REF-005 a REF-009 | `BACKLOG_TECHNIQUE` / `A_CORRIGER_C4E` non bloquant |
