...
│   ├── 75_hydro_barrage_param_model/
│   ├── 76_referentiel_parametre_canonique/
│   ├── 77_validation_finale_migration/
│   ├── 84_hydro_barrage_param_deploiement/
...
- lire d’abord `docs/00_SOURCE_OF_TRUTH_MASTER.md`
- puis `docs/01_project_reference/SOURCE_OF_TRUTH.md`
