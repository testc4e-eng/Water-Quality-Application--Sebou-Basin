...
WHERE table_schema = 'hydro' AND table_name = 'mesure_debit_source'
ORDER BY ordinal_position;

-- 4. Qualité valeurs pour valeur_m3s
SELECT COUNT(*) FILTER (WHERE "valeur_m3s" IS NULL) AS nb_null, COUNT(*) AS volume_total
...
-- SELECT ... FROM "hydro"."mesure_debit_source"
