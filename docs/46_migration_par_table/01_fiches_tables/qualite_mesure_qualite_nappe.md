# Fiche table - qualite.mesure_qualite_nappe

## 1. Identification
- Schéma : `qualite`
- Table : `mesure_qualite_nappe`
- Statut : `PENDING`
- Priorité : `Critique`
- Volume source : `63088` lignes
- Script SQL en attente : `../sql_en_attente/qualite_mesure_qualite_nappe.sql`
...
- Lignes inventaire `39` associées : `71`
