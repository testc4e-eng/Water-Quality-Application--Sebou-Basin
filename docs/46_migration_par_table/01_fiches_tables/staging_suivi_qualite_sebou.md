# Fiche table - staging.suivi_qualite_sebou

## 1. Identification
- Schéma : `staging`
- Table : `suivi_qualite_sebou`
- Statut : `PENDING`
- Priorité : `Critique`
- Volume source : `51402` lignes
- Script SQL en attente : `../sql_en_attente/staging_suivi_qualite_sebou.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `parametre_qualite`
- Colonnes valeurs : `val_qual_sebou_jr`
