# Fiche table - staging.mesures_debit_sources
...
- Statut : `PENDING`
- Priorité : `Critique`
- Volume source : `2816` lignes
- Script SQL en attente : `../sql_en_attente/staging_mesures_debit_sources.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `aucune`
- Colonnes valeurs : `debit`
- Colonnes dates : `moment`
...
- Exemples : `842 | 273 | 2206`

## 5. Croisement avec les audits existants
- Lignes inventaire `39` associées : `0`
- Lignes décision migration `42` associées par paramètre : `5`
- Cas de validation `44` associés par paramètre : `4`
