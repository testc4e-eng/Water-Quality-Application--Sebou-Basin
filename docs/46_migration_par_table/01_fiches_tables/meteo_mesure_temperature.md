# Fiche table - meteo.mesure_temperature

## 1. Identification
- Schéma : `meteo`
- Table : `mesure_temperature`
- Statut : `PENDING`
- Priorité : `Moyenne`
- Volume source : `0` lignes
- Script SQL en attente : `../sql_en_attente/meteo_mesure_temperature.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `aucune`
- Colonnes valeurs : `val_min, val_max, val_moy`
- Colonnes dates : `temps`
...
|---|---|---:|
| val_min | colonne_large | 0 |
| val_max | colonne_large | 0 |
| val_moy | colonne_large | 0 |
