# Fiche table - hydro.mesure_barrage

## 1. Identification
- Schéma : `hydro`
- Table : `mesure_barrage`
- Statut : `PENDING`
- Priorité : `Moyenne`
- Volume source : `84831` lignes
- Script SQL en attente : `../sql_en_attente/hydro_mesure_barrage.sql`
...
|---|---|---:|
| volume_mm3 | colonne_large | 84831 |

## 4. Analyse qualité
- Valeurs nulles détectées : `74695`
