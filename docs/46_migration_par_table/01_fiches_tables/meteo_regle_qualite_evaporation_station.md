# Fiche table - meteo.regle_qualite_evaporation_station

## 1. Identification
- Schéma : `meteo`
- Table : `regle_qualite_evaporation_station`
- Statut : `PENDING`
- Priorité : `Moyenne`
- Volume source : `390` lignes
- Script SQL en attente : `../sql_en_attente/meteo_regle_qualite_evaporation_station.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `aucune`
- Colonnes valeurs : `aucune`
- Colonnes dates : `updated_at`
