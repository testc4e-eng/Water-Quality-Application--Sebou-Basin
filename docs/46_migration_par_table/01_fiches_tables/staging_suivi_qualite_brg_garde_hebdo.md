# Fiche table - staging.suivi_qualite_brg_garde_hebdo

## 1. Identification
- Schéma : `staging`
- Table : `suivi_qualite_brg_garde_hebdo`
- Statut : `PENDING`
- Priorité : `Critique`
- Volume source : `7094` lignes
- Script SQL en attente : `../sql_en_attente/staging_suivi_qualite_brg_garde_hebdo.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `parametre_qualite`
- Colonnes valeurs : `val_qual_brg_garde_hebdo`
