# Fiche table - staging._legacy_qualite_riviere

## 1. Identification
- Schéma : `staging`
- Table : `_legacy_qualite_riviere`
- Statut : `PENDING`
- Priorité : `Critique`
- Volume source : `60097` lignes
- Script SQL en attente : `../sql_en_attente/staging_legacy_qualite_riviere.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `parametre_qualite`
- Colonnes valeurs : `val_qual_riv`
