# Fiche table - hydro.mesure_debit_source

## 1. Identification
- Schéma : `hydro`
- Table : `mesure_debit_source`
- Statut : `PENDING`
- Priorité : `Moyenne`
- Volume source : `2816` lignes
- Script SQL en attente : `../sql_en_attente/hydro_mesure_debit_source.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `aucune`
- Colonnes valeurs : `valeur_m3s`
- Colonnes dates : `temps, qa_checked_at, created_at`
