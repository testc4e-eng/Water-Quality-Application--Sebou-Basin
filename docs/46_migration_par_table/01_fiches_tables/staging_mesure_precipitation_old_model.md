# Fiche table - staging.mesure_precipitation_old_model

## 1. Identification
- Schéma : `staging`
- Table : `mesure_precipitation_old_model`
- Statut : `PENDING`
- Priorité : `Moyenne`
- Volume source : `507930` lignes
- Script SQL en attente : `../sql_en_attente/staging_mesure_precipitation_old_model.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `aucune`
- Colonnes valeurs : `valeur`
- Colonnes dates : `temps, pas_temps`
