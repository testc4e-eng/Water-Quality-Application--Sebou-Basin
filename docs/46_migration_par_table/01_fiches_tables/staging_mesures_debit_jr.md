# Fiche table - staging.mesures_debit_jr
...
- Statut : `PENDING`
- Priorité : `Critique`
- Volume source : `173251` lignes
- Script SQL en attente : `../sql_en_attente/staging_mesures_debit_jr.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `aucune`
- Colonnes valeurs : `code_debit, debit_jr`
...
|---|---|---:|
| code_debit | colonne_large | 173251 |
| debit_jr | colonne_large | 173251 |
