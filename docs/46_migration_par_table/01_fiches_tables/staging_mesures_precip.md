# Fiche table - staging.mesures_precip

## 1. Identification
- Schéma : `staging`
- Table : `mesures_precip`
- Statut : `PENDING`
- Priorité : `Élevée`
- Volume source : `669880` lignes
- Script SQL en attente : `../sql_en_attente/staging_mesures_precip.sql`

## 2. Colonnes détectées
- Colonnes paramètres : `aucune`
- Colonnes valeurs : `id_precipitation_jr, precipitation_jr`
...
|---|---|---:|
| id_precipitation_jr | colonne_large | 669880 |
| precipitation_jr | colonne_large | 669880 |

## 4. Analyse qualité
- Valeurs nulles détectées : `161950`
- Valeurs non numériques détectées : `0`
- Valeurs négatives détectées : `0`
- Unités observées : `à confirmer`
- Exemples : `85485 | 85486 | 85487 | 0`
