...
- filtre : `source_table = 'raw_mesures_qualite_rivieres'`
- jointure brute : `staging.raw_mesures_qualite_rivieres.id::text = source_row_id`
...
- déduplication du référentiel : `DISTINCT ON (code_canonique)` pour neutraliser le doublon `DEBIT`
...
- volume préparé brut : `60 074`
- volume quarantaine exclu : `11`
- lignes gardées après dédoublonnage : `59 534`
- lignes écartées : `540`
